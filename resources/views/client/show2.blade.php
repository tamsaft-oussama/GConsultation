        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <h3 class="profile-username text-center">{{$client->numTel}}</h3>
              ...
              @if($client->nom)<p class="text-muted text-center">{{$client->nom}}</p>@endif
              @if($client->ville)<p class="text-muted text-center">{{$client->ville}}</p>@endif
              @if($client->email)<p class="text-muted text-center">{{$client->email}}</p>@endif
