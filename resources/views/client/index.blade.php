        ...
        <div class="offset-sm-2 col-sm-8 offset-md-3 col-md-6">
            <div class="card card-dark ">
              <div class="card-body row ">
                <form class="col-lg-4 mt-2" method="post" action="{{ route('client.search') }}">
                  @csrf
                    <div class="input-group">
                        <input name="search" type="tel" pattern="[0-9]{10}" class="form-control form-control-sm" placeholder="Ex:0610101111" required>
                ...
                <div class="col-lg-4 mt-2">
                  <a type="button" class="btn btn-sm btn-warning btn-block" title="Chaque recherche que vous effectuez soustrait un point à votre solde">
                    Solde : <span class="badge badge-light">{{  $user->count }}</span>
                  </a>
                </div>
                <div class="col-lg-4 mt-2">
                  <a class="card-link btn btn-sm btn-danger btn-block mr-3 text-light" data-toggle="modal" data-target="#addClienInfo"><i class="fas fa-user-plus"></i> Ajouter un client</a>
                </div>
