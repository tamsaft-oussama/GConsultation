            ...
            <tbody>
              @foreach ($clients as $client)
                <tr>
                  ...
                  <td>{{$client->email}}</td>
                  <td class="stars">
                    <span class="fa fa-star @if($client->reclamations->count()<60) checked @endif"></span>
                    <span class="fa fa-star @if($client->reclamations->count()<50) checked @endif"></span>
                    <span class="fa fa-star @if($client->reclamations->count()<40) checked @endif"></span>
                    <span class="fa fa-star @if($client->reclamations->count()<30) checked @endif" ></span>
                    <span class="fa fa-star @if($client->reclamations->count()<15) checked @endif"></span>
